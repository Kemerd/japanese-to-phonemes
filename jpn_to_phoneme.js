 ...
 * Usage: node jpn_to_phoneme.js "日本語テキスト"
 */
...
class BinaryTrieNode {
  constructor(data, base, version = 2) {
    this.nodeData = data;
    this.fileBase = base;
...
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// SEGMENT TYPES FOR FURIGANA HINT PROCESSING
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

const SegmentType = {
  NORMAL_TEXT: 0,      // Regular text without furigana
  FURIGANA_HINT: 1     // Text with furigana reading hint
};
...
class PhonemeConverter {
  ...
  tryLoadBinaryFormat(filePath) {
    ...
    for (let i = 0; i < entryCountVal; i++) {
      ...
      const valueLen = readVarint(buffer, ptrVal);
      offset = ptrVal.value;
...
class WordSegmenter {
   ...
   */
  segmentFromSegments(segments, phonemeRoot = null) {
    const words = [];
    ...
    for (const segment of segments) {
      ...
      while (pos < codePoints.length) {
        ...
        if (matchLength === 0 && phonemeRoot) {
          let phonemeCurrent = phonemeRoot;
 ...
 */
function convertWithSegmentation(converter, text, segmenter) {
